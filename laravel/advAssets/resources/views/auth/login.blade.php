                ...
                <div class="login-clean">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <a class="d-none" href="#">Olvidaste tu contraseña?</a><button
                            class="btn btn-primary btn-block search-button mb-3" type="submit">Ingresar</button>
                        <p class="text-center text-hover"><a href="signup.html">¿Aún no estas registrado? Regístrate y
