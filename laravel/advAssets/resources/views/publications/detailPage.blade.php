        ...
        <div class="row">
            <div class="col col-md-8 col-12">
                ...
                <div class="d-flex mx-3 justify-content-center mb-5">
                    <div class="d-flex align-items-center mr-3"><i class="fa fa-cubes icon icon-blue"></i><span
                            class="font-weight-bolder">{{ $Publication->dimName }}</span></div>
                    <div class="d-flex align-items-center"><i class="far fa-file icon icon-blue"></i><span
                            class="font-weight-bolder">{{ $Publication->formName }}</span></div>
                </div>
                <div>
            ...
            <div class="col col-12 col-md-4">
                <div class="user-detail-banner rounded d-flex flex-column align-items-center p-3 mb-3">
                    <div class="rounded-circle big-user-circle mb-3"
                        style="background: url(/users/profile_images/{{ $Publication->user_id }}) center/ contain no-repeat;">
                    </div>
                    <h4 class="mb-1">{{ $Publication->full_name }}<br></h4><span>{{ $Publication->email }}</span>
                </div>
                <div><a class="btn btn-primary btn-lg btn-download w-100 btn-big" href="{{ $Publication->url }}"
                        target="_blank" role="button">Descargar modelo</a></div>
            </div>
        </div>
    </div>
@endsection
